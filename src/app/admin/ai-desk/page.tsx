            ...
            <main className="flex-1 overflow-y-auto">
                <div className="p-8 md:p-12 mb-20 max-w-7xl mx-auto font-display">
                    ...
                    <header className="mb-12 flex items-center justify-between border-b border-white/5 pb-6">
                        ...
                        {/* Dashboard Token Progress (Optional simplified view) */}
                    ...
                    {/* UPPER SECTION: Pipeline Dashboard */}
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-16 animate-fade-in">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-12 max-w-4xl mx-auto animate-fade-in-up">
