    ...
    return (
        <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-black px-6 text-white">
            ...
            <section className="relative z-10 w-full max-w-3xl border border-white/10 bg-white/[0.03] p-8 backdrop-blur-sm md:p-12">
                <p className="font-display text-[10px] uppercase tracking-[0.4em] text-accent-green">Maintenance Mode</p>
                ...
                <div className="mt-10 grid gap-4 md:grid-cols-3">
                    <div className="border border-white/10 bg-black/30 p-5">
                        ...
                        <p className="mt-2 text-sm text-gray-400">관리자 페이지와 운영 기능은 계속 사용할 수 있습니다.</p>
                    </div>
                    <div className="border border-white/10 bg-black/30 p-5">
                        <p className="font-display text-[10px] uppercase tracking-[0.3em] text-gray-500">ETA</p>
                        <p className="mt-3 text-lg text-white">{settings.maintenanceEta || '복구 예정 시간 미정'}</p>
                        <p className="mt-2 text-sm text-gray-400">관리자에서 입력한 복구 예정 시간이 있으면 여기에 표시됩니다.</p>
                    </div>
                    <div className="border border-white/10 bg-black/30 p-5">
                        ...
                        <p className="mt-2 text-sm text-gray-400">급한 문의가 있으면 위 메일로 연락할 수 있습니다.</p>
                    </div>
                </div>
